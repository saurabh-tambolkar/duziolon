...
export default function PrivacyPolicy() {
    ...
    <main className="bg-white min-h-screen">
      <div className="max-w-5xl mx-auto px-6 py-12 mt-24">
        ...
        <p>
          ...
          created with the help of thePrivacy Policy Generator.
        </p>
        <h2 className="text-3xl font-bold mt-8 my-4">
          Interpretation and Definitions
        </h2>
        <h3 className="text-2xl font-bold mb-2">Interpretation</h3>
        <p>
        ...
        <h3 className="text-2xl font-bold mb-2 mt-8">Definitions</h3>
        <p>For the purposes of this Privacy Policy:</p>
        <ul className="list-disc pl-6 space-y-5 text-gray-700 leading-7">
  <li>
    <strong>Account</strong> means a unique account created for you to access our Service or parts of our Service.
  </li>

  <li>
    <strong>Affiliate</strong> means an entity that controls, is controlled by, or is under common control with a party, where <strong>"control"</strong> means ownership of 50% or more of the shares, equity interest, or other securities entitled to vote for election of directors or other managing authority.
  </li>

  <li>
    <strong>Company</strong> (referred to as <strong>"the Company"</strong>, <strong>"We"</strong>, <strong>"Us"</strong>, or <strong>"Our"</strong> in this Privacy Policy) refers to <strong>Duziolon</strong>.
  </li>

  <li>
    <strong>Cookies</strong> are small files placed on your computer, mobile device, or any other device by a website, containing details of your browsing history and other information used to improve your experience.
  </li>

  <li>
    <strong>Country</strong> refers to <strong>Maharashtra, India</strong>.
  </li>

  <li>
    <strong>Device</strong> means any device capable of accessing the Service, such as a computer, mobile phone, or tablet.
  </li>

  <li>
    <strong>Personal Data</strong> (or <strong>Personal Information</strong>) means any information relating to an identified or identifiable individual.
    <p className="mt-2">
      We use the terms <strong>"Personal Data"</strong> and <strong>"Personal Information"</strong> interchangeably unless a specific law requires otherwise.
    </p>
  </li>
  ...
  <li>
    <strong>Service Provider</strong> means any individual or legal entity that processes data on behalf of the Company, including third-party companies or individuals that help operate, maintain, or improve the Service.
  </li>

  <li>
    <strong>Usage Data</strong> refers to information collected automatically through the use of the Service, such as page visits and browsing duration.
  </li>

  <li>
    <strong>Website</strong> refers to <strong>Duziolon</strong>, accessible at{" "}
    <a
      href="https://duziolon.vercel.app"
      target="_blank"
  ...
  <li>
    <strong>You</strong> means the individual accessing or using the Service, or the company or other legal entity on whose behalf such individual is accessing or using the Service.
  </li>
</ul>
        <h2 className="text-3xl font-bold mb-2 mt-8">
          Collecting and Using Your Personal Data
        </h2>
        <h3 className="text-2xl font-bold mt-8 mb-2">Types of Data Collected</h3>
        <h4 className="text-xl font-bold mt-4 mb-2">Personal Data</h4>
        <p>
        ...
        <h4 className="text-xl font-bold mt-4 mb-2">Usage Data</h4>
        ...
        <h4 className="text-xl font-bold mt-4 mb-2">Tracking Technologies and Cookies</h4>
        <p>
        ...
        <p  className="mb-4">
          ...
          needed for the relevant purpose. We apply different retention periods
          to different categories of Personal Data based on the purpose of
          processing and legal obligations:
        </p>
        <ul className="list-disc pl-6 space-y-5 text-gray-700 leading-7">
          <li>
            <p>Account Information</p>
           <ul className="list-decimal pl-6 space-y-5 text-gray-700 leading-7">
              <li>
        ...
        <h4 className="text-2xl font-bold mb-2 mt-8">Business Transactions</h4>
        <p>
        ...
        <h4 className="text-2xl font-bold mb-2 mt-8">Law enforcement</h4>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h4 className="text-2xl font-bold mb-2 mt-8">Other legal requirements</h4>
        <p>
          The Company may disclose Your Personal Data in the good faith belief
          that such action is necessary to:
        </p>
        <ul className="list-disc pl-6 space-y-5 text-gray-700 leading-7 mt-4">
        ...
        <h3 className="text-xl font-bold mt-8 mb-2">Security of Your Personal Data</h3>
        <p>
        ...
        <h2 className="text-3xl font-bold mb-2 mt-8">Children's Privacy</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mb-2 mt-8">Links to Other Websites</h2>
        <p className="mb-4">
        ...
        <ul className="list-disc pl-6 space-y-5 text-gray-700 leading-7">
          <li>
            ...
            website: <Link href="https://duziolon.vercel.app/contact" className="hover:underline" target="_blank" rel="noopener noreferrer">
              https://duziolon.vercel.app/contact
            </Link>
          </li>
        </ul>
      </div>
