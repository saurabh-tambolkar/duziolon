...
import {formatDate} from "../../../../components/OrderItem"
...
function page({params}) {
  ...
  return (
    <div className="min-h-screen pt-30 mx-auto w-10/12 ">
      {
        loading ?
        ...
        <div className='bg-white shadow-sm border p-2 rounded-lg mt-6 flex justify-between items-center'>
          <div>
